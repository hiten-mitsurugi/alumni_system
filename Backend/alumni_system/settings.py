...
# === Caching ===
# Temporarily using dummy cache instead of Redis for development
CACHES = {
    'default': {
...
# Redis cache configuration (commented out until Redis is available)
# CACHES = {
#     'default': {
...
# === Channels ===
# Temporarily using in-memory channel layer for development (no Redis dependency)
CHANNEL_LAYERS = {
    'default': {
...
# Redis channel layer configuration (commented out until Redis is available)
# CHANNEL_LAYERS = {
#     'default': {
