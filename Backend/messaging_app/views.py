...
from .models import Message, GroupChat, MessageRequest, BlockedUser, GroupMemberRequest
            ...
            if action == 'add_member':
                ...
                try:
                    ...
                    try:
                        ...
                        # Serialize the group data for the new member
                        ...
                        logger.info(f"Sent group added notification to user {new_member.id}")
                        
                    except Exception as e:
                        logger.error(f"Error sending group added notification: {e}")
                        
                except User.DoesNotExist:
                    logger.error(f"User {user_id} not found when adding to group")
