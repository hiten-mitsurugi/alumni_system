...
class CustomUser(AbstractUser):
    ...
    REQUIRED_FIELDS = ['username', 'school_id', 'first_name', 'last_name', 'program']
...
class Profile(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        self.school_id = self.user.school_id or 'N/A'
        self.mobile_number = self.user.contact_number or 'N/A'
        self.sex = self.user.gender or 'prefer_not_to_say'
        self.civil_status = self.user.civil_status or 'single'
        self.year_of_birth = self.user.birth_date or '1990-01-01'
        self.present_address = self.user.present_address or 'N/A'
        self.permanent_address = self.user.permanent_address or 'N/A'
        self.mothers_name = self.user.mothers_name or 'N/A'
        self.mothers_occupation = self.user.mothers_occupation or 'N/A'
        self.fathers_name = self.user.fathers_name or 'N/A'
        self.fathers_occupation = self.user.fathers_occupation or 'N/A'
        self.year_graduated = self.user.year_graduated or 2020
        self.program = self.user.program or 'N/A'
        ...
        if current_job:
            ...
            # Provide defaults if no current job exists
            self.present_employment_status = self.user.employment_status or 'unemployed'
            self.employment_classification = ''
            self.present_occupation = ''
            self.employing_agency = ''
