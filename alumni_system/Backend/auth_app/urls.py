...
urlpatterns = [
    ...
    path('survey/categories/', SurveyCategoryListCreateView.as_view(), name='survey_categories'),
    path('survey/categories/<int:pk>/', SurveyCategoryDetailView.as_view(), name='survey_category_detail'),
    path('survey/questions/', SurveyQuestionListCreateView.as_view(), name='survey_questions'),
    path('survey/questions/<int:pk>/', SurveyQuestionDetailView.as_view(), name='survey_question_detail'),
    path('survey/active-questions/', ActiveSurveyQuestionsView.as_view(), name='active_survey_questions'),
