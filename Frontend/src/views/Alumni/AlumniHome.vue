  ...
  <div class="min-h-screen bg-gray-50">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-14 md:h-16">
          ...
          <div class="flex items-center space-x-4 flex-1">
            <h1 class="text-lg md:text-xl font-bold text-gray-900">Home</h1>
          </div>
          ...
          <div class="flex items-center space-x-3 flex-1 justify-end">
            ...
            <button
              ...
              class="md:hidden p-2 text-blue-600 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors"
            >
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="max-w-7xl mx-auto px-2 sm:px-3 md:px-4 lg:px-6 py-2 sm:py-4 md:py-6">
      <div class="flex flex-col lg:flex-row gap-2 sm:gap-3 lg:gap-4">
          ...
          >
            <div class="bg-white rounded-xl w-full max-w-md max-h-[80vh] overflow-y-auto">
              <div class="p-4 border-b border-gray-200 flex items-center justify-between">
                ...
                <button @click="showCreateForm = false" class="p-1 hover:bg-gray-100 rounded">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Right Sidebar: Connection Widgets (Desktop only) -->
...
/* Sidebar styles - adjusted for better centering */
.lg\:w-64 {
  width: 16rem;
  max-width: 16rem;
}
