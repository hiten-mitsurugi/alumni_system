    ...
    <div v-else-if="activeTab === 'analytics'" class="space-y-6">
            ...
            >
              ...
              <td class="px-6 py-4">
                <span :class="[
                  ...
                  {{ getResponseCountByCategory(category.id) }} responses
                </span>
              </td>
              <td class="px-6 py-4">
                <span :class="[
              ...
              <td class="px-6 py-4 text-right space-x-2">
                <button
                  @click="viewCategoryAnalytics(category)"
                ...
                <button
                  @click="exportCategoryExcel(category)"
      ...
      <div v-if="analytics" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
        ...
        <div :class="[
          ...
          <p :class="[
            'text-3xl font-bold',
            isDark ? 'text-white' : 'text-amber-700'
          ]">{{ analytics.total_users_responded }}</p>
        </div>
