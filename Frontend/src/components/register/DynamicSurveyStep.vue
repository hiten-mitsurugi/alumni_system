<template>
  <div>
    <!-- Category Header -->
    <div class="mb-6">
      <h4 class="mb-2 text-lg font-semibold text-gray-800">{{ category.name }}</h4>
          ...
          >
            ...
            >
              <input
                ...
                :required="question.is_required"
                class="w-4 h-4 mr-2 text-blue-600 border-gray-300 focus:ring-blue-500"
              />
              <label
            ...
            <div class="flex items-center space-x-2">
              ...
              >
                ...
                <label
                  ...
                  class="mt-1 text-sm text-gray-700 cursor-pointer"
                >
                  {{ rating }}
                </label>
              </div>
...
watch(
  ...
  (newResponses) => {
    ...
    props.questions.forEach(question => {
      if (question.depends_on_question_id && question.depends_on_value) {
        // Check if question should be visible with current responses
        if (!isQuestionVisible(question)) {
