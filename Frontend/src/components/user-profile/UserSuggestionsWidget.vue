<template>
  <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 transition-colors duration-200">
    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">People you may know</h3>
    ...
    <div v-else-if="suggestions.length > 0" class="space-y-3">
      ...
      >
        ...
        >
          <p class="text-sm font-medium text-gray-900 dark:text-white truncate hover:text-green-600 dark:hover:text-green-400 transition-colors">
        ...
        <button 
          ...
          class="px-2 py-1 text-xs bg-green-600 text-white rounded-full hover:bg-green-700 transition-colors disabled:opacity-50"
        >
      ...
      <div class="pt-3 border-t border-gray-200 dark:border-gray-700">
        <router-link 
          ...
          class="block text-center text-sm text-green-600 hover:text-green-700 dark:text-green-400 dark:hover:text-green-300 font-medium"
        >
    ...
    <div v-else class="text-center py-4">
      ...
      <p class="text-gray-500 dark:text-gray-400 text-sm">No suggestions available</p>
    </div>
  </div>
</template>
