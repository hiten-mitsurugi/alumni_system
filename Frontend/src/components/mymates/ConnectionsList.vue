  ...
  <div class="space-y-6">
    <div v-if="connections.length > 0">
      <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-4 space-y-2 sm:space-y-0">
        <h2 class="text-base sm:text-lg font-semibold text-gray-900">My Connections</h2>
        <div class="flex items-center space-x-4">
          <div class="relative w-full sm:w-56">
            <input
              ...
              class="w-full pl-7 pr-3 py-1.5 sm:py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 text-sm"
            />
            <svg class="absolute left-2 top-2 sm:top-2.5 h-3.5 w-3.5 sm:h-4 sm:w-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div v-else class="text-center py-12">
      ...
      <p class="text-gray-600">Start connecting with fellow alumni to grow your network!</p>
    </div>
  </div>
</template>
