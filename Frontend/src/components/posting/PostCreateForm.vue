    ...
    <div class="p-8">
      ...
      <div class="flex items-center justify-between mt-8 pt-6 border-t-2 border-slate-200">
        <div class="flex items-center space-x-6">
          <!-- File Upload -->
          <label class="flex items-center space-x-2 text-slate-600 hover:text-blue-600 cursor-pointer border border-slate-300 hover:border-blue-600 px-3 py-2 rounded-full transition-all duration-300 group bg-transparent">
        ...
        <button
          ...
          :class="[
            'px-6 py-2.5 rounded-full font-medium text-base transition-all duration-300 flex items-center space-x-2 border',
            localContent.trim() && !isPosting
              ? 'border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white hover:scale-105 bg-transparent'
              : 'border-slate-300 text-slate-400 cursor-not-allowed bg-transparent'
          ]"
        >
...
const cardClasses = computed(() => [
  'rounded-3xl shadow-xl border-2 mb-8 overflow-hidden',
...
const inputClasses = computed(() => [
  'w-full p-4 text-xl border-2 rounded-2xl mb-4 focus:ring-4 focus:ring-blue-300 focus:border-blue-500 shadow-md',
  themeStore.isDarkMode
...
const textareaClasses = computed(() => [
  'w-full p-4 text-lg border-2 rounded-2xl resize-none focus:ring-4 focus:ring-blue-300 focus:border-blue-500 shadow-md',
  themeStore.isDarkMode
    ? 'bg-slate-700 border-slate-600 text-white placeholder-slate-400'
    : 'bg-white border-slate-300 text-slate-900 placeholder-slate-500'
])
...
const selectClasses = computed(() => [
  'text-sm font-medium border border-slate-300 hover:border-slate-400 rounded-full px-4 py-2 pr-10 focus:ring-2 focus:ring-slate-400 focus:border-slate-400 outline-none appearance-none',
  themeStore.isDarkMode
    ? 'bg-slate-800 border-slate-600 text-white hover:border-slate-500 focus:ring-slate-500'
    : 'bg-white border-slate-300 text-slate-700 hover:border-slate-400 focus:ring-slate-400'
])
